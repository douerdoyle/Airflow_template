import time, os, traceback, math, requests
import pandas as pd
from copy   import deepcopy
from pprint import pprint
from func_tools import word2num
        ...
        for index, cell_content in enumerate(df['total floor number']):
            ...
            try:
                ...
                # 處理樓層數是 「十三層」、「三十七層」的狀況
                    ...
                    floor_chn2int[cell_content] = deepcopy(word2num(df['total floor number'][index].replace('層', '')))
                else:
                    print('error_1')
